...
public class scoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        mHolder.home_crest.setImageResource(Utility.getTeamCrestByTeamName(homeName));

        mHolder.away_crest.setImageResource(Utility.getTeamCrestByTeamName(awayName));
